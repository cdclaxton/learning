...
def entities_list_of_pickled_list_compiled(
    data: List[bytes], min_count: int, num_entities: int,
...
def entities_list_of_pickled_set_compiled(
    data: List[bytes], min_count: int,num_entities: int,
) -> List[Tuple[int, int, int]]:
...
def entities_list_of_strings_compiled(
    data: List[str], min_count: int,num_entities: int,
) -> List[Tuple[int, int, int]]:
